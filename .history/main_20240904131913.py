...
# Clients
app = FastAPI(title="Bitget Pau's API", servers=[{"url": "http://3.141.197.183:8000"}, {"url": "http://18.116.69.127:8000"}])
...
# CRYPTO INSTITUCIONAL NEWS
@app.get("/today_news", tags=["Text Analysis"])
